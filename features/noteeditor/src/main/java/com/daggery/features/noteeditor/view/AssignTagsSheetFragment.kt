...
import com.daggery.features.noteeditor.databinding.FragmentAssignTagsBottomSheetBinding
...
@AndroidEntryPoint
class AssignTagsSheetFragment(private val updateTagsCallback: (List<String>) -> Unit) : BottomSheetDialogFragment() {
    ...
    private val editorViewModel: NoteEditorViewModel by activityViewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val tagNameList = editorViewModel.getTags().map { it.tagName }
